      ...
      <KeyboardAvoidingView style={styles.container} behavior="padding" enabled>
        <View behavior="padding" style={styles.container}>
          <View style={styles.logoContainer}>
            <Image style={styles.logo} source={require('../Component/Image/logo.png')} />
          ...
          <View style={styles.formContainer}>
            <View style={styles.subformcontainer}>
              ...
              />
              {
                !passwordMatch ? <Text style={styles.error}>**Password is wrong</Text> : null
              }
              <TouchableOpacity style={styles.buttonContainer}>
                <Text onPress={onSumit} style={styles.buttonText}>LOGIN</Text>
              </TouchableOpacity>
              <View style={styles.signupTextCont}>
                <Text style={styles.signupText}>Already Account yet?</Text>
